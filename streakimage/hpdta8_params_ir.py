...
Camera = namedtuple(
    "Camera",
    "AMD EMD NMD SMD ADS SHT FBL EST SHA SFD SPX TNS ATP CEG CEO ESC LMD SHO SHW SVO SVW TimingMode TriggerMode TriggerSource VerticalBinning TapNo TriggerPolarity CCDArea Binning ScanMode LightMode SubarrayHOffs SubarrayHWidth SubarrayVOffs SubarrayVWidth NoLines CameraName Type SubType",
    defaults=(
        None,
        None,
        None,
...
Grabber = namedtuple("Grabber", "ConfigFile Type SubType")
...
Streakcamera = namedtuple(
    "Streakcamera",
    "UseDevice DeviceName PluginName InstalledOption1 GPIBCableConnected GPIBBase TimeRange Mode GateMode MCPGain Shutter BlankingAmp GateTime Delay Phase FocusTimeOver",
    defaults=(
        None,
        None,
        None,
...
Delaybox = namedtuple(
    "Delaybox",
    "UseDevice DeviceName PluginName GPIBCableConnected GPIBBase DelayTime LockMode DeviceStatus",
)
